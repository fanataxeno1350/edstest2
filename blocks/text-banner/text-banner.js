...
export default function decorate(block) {
  ...
  if (titleCell) {
    ...
    title.textContent = titleCell.firstElementChild?.textContent.trim(); // Access firstElementChild to get the div inside
  ...
  if (descriptionCell) {
    ...
    descriptionContent.innerHTML = descriptionCell.firstElementChild?.innerHTML; // Access firstElementChild to get the div inside
  ...
  if (ctaLinkCell && ctaLabelCell) {
    ...
    if (foundLink) {
      ctaLink.href = foundLink.getAttribute('href'); // Use getAttribute('href') for aem-content type
    }
    ...
    ctaLabelSpan.textContent = ctaLabelCell.firstElementChild?.textContent.trim(); // Access firstElementChild to get the div inside
